            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><i class="fas fa-edit"></i> Chỉnh sửa: {{ $attribute->name }}</h5>
                    </div>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-select">
                                    <option value="1" {{ old('status', $attribute->status) == 1 ? 'selected' : '' }}>Hoạt động</option>
                                    <option value="0" {{ old('status', $attribute->status) == 0 ? 'selected' : '' }}>Ẩn</option>
                                </select>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-end">
                            <a href="{{ route('attributes.show', $attribute) }}" class="btn btn-outline-secondary">
