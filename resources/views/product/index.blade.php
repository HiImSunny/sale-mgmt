    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-secondary mb-0">Tổng: {{ $stats['total'] }} sản phẩm</p>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 text-info">{{ $stats['in_stock'] }}</h3>
                            </div>
                            <div class="text-info">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-muted mb-1">Có biến thể</h6>
                                <h3 class="mb-0 text-warning">{{ $stats['with_variants'] }}</h3>
                            </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <button type="button" class="btn btn-danger btn-sm" onclick="bulkDelete()" style="display: none;"
                            id="bulk-delete-btn">
